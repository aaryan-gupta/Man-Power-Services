        ...
        <form action="process.php" method="POST" enctype="multipart/form-data" id="workersProfileForm">
            ...
            <div class="form-row mt-3">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="txtUid" name="txtUid" readonly
            ...
            <div class="form-row mt-2">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="txtSpecialization" id="txtSpecialization" class="form-control">
                </div>
            </div>
            <div class="form-row mt-2">
                <div class="form-group col-md-3">
                    <center><label for="txtExp">EXPERIENCE IN YEARS</label></center>
                    <input type="number" name="txtExp" id="txtExp" class="form-control">
                </div>
                <div class="form-group col-md-4">
                    <center><label for="txtFirm">FIRM/SHOP NAME</label></center>
                    <input type="text" class="form-control" name="txtFirm" id="txtFirm">
                </div>
            ...
            <div class="form-row mt-2">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" class="form-control" id="txtPin" name="txtPin">
                </div>
                <div class="form-group col-md-3">
                    <center><label for="txtInfo">OTHER INFORMATION</label></center>
                    <textarea name="txtInfo" id="txtInfo" cols="30" rows="1" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-row mt-2">
                <div class="form-group col-md-6">
                    <center>
                        ...
                        <input type="file" class="form-control" id="picAadhar" name="picAadhar"
                            onchange="showpreviewAadhar(this);">
                    </center>
                </div>
                <div class="form-group col-md-6">
                    <center>
                ...
                <div class="form-group col-md-6">
                    <center>
                        ...
                        <input type="file" class="form-control" id="picProfile" name="picProfile"
                            onchange="showpreviewProfile(this);">
                    </center>
                </div>
                <div class="form-group col-md-6">
                    <center>
